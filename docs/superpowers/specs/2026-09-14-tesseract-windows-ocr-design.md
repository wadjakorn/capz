...
| การกระจาย | bundle เข้า `.msi` | ผู้ใช้ได้ของครบตั้งแต่ติดตั้ง ไม่มี error path เรื่องเน็ต ไม่ขัดหลัก "no cloud in v1" |
...
## 9. คำถามที่ยังไม่มีคำตอบ — ต้องตอบก่อนเริ่ม implement
